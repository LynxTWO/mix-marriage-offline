...
We expect contributors, maintainers, and community members to:
...
- Sexualized comments or unwanted sexual attention.
- Doxxing or sharing private information.
- Persistent trolling, derailing, or “debate as domination.”
- Misrepresenting a contributor’s work or intent in a way that invites pile-ons.
...
- What happened (links, screenshots, quotes).
- Where it happened (issue/PR/discussion link).
- When it happened (date/time if possible).
- Any safety concerns (urgent vs non-urgent).

## Enforcement

Maintainers may take any action needed to protect the community, including:

- Private warning and behavior request.
- Content removal or thread lock.
- Temporary ban from participation.
- Permanent ban from the project spaces.

Enforcement decisions are based on behavior and impact, not “who started it.”
