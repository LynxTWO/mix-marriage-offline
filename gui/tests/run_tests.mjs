...
import { run as runAuditionOverlayTests } from "./audition_overlays.test.mjs";
import { run as runDashboardVisualsTests } from "./dashboard_visuals.test.mjs";
...
const suites = [
  ...
  { name: "audition_overlays", run: runAuditionOverlayTests },
  { name: "dashboard_visuals", run: runDashboardVisualsTests },
