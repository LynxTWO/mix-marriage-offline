...
# Scene binding statuses: whether an incoming scene was already canonical,
# rewritten to canonical report stems, only partially bound, or failed to bind.
SCENE_BINDING_STATUS_NOT_APPLICABLE = "not_applicable"
SCENE_BINDING_STATUS_CLEAN = "clean"
SCENE_BINDING_STATUS_REWRITTEN = "rewritten"
SCENE_BINDING_STATUS_PARTIAL = "partial"
SCENE_BINDING_STATUS_FAILED = "failed"
SCENE_BINDING_STATUSES = (
